...
write_to_filename <- paste0("SupplyChainGHGEmissionFactors_",SEFversion,"_BEA-IS_CO2e_USD", dollaryear, ".csv")
...
write_to_filename <- paste0("SupplyChainGHGEmissionFactors_",SEFversion,"_BEA-IS_byGHG_USD", dollaryear,".csv")
